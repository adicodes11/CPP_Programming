// A program to have the compiler tell us what kind of expression something is. 
// The following code demonstrates a method that determines whether an expression is an lvalue or an rvalue:
